...
void look_away_callback(const sensor_msgs::Image img)
{
    ...
    // Steve: I'm not a fan of this method, seems gimicky, and I would rather have had a direct intro to a more through method.
    // I would try measuring the gradient and then do statistics to detect structure.
